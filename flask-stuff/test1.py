...
class FlaskTests(unittest.TestCase):
        ...
        def test_sign_in_good(self):
            ...
            response = tester.post('/signup', data=json.dumps(dict(username=name_to_save, password='1234', first_name='Bruno', last_name='Da Silva'), content_type='application/json'))
            tester.post('/', data=json.dumps(dict(username=name_to_save, password='1234'), content_type='application/json'))
